...
/// Simple example that shows you how you can use the driver along with crate "sysfs_gpio" to display
...
fn main() {
    ...
    let tm1637display = setup_sysfs_gpio(clk_pin, dio_pin, bit_delay_fn);
